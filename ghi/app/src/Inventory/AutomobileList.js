...
useEffect(() => {
    ...
    return (
        <div className="container">
            ...
            <div className="col-md-12 text-center">
            <button type="button" className="btn btn-success"><NavLink style={{color:"white"}} className="nav-link" aria-current="page" to="/automobiles/new">Create an automobile</NavLink></button>
            </div>
